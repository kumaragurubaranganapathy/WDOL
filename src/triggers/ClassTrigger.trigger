...
* Name: ClassTrigger
* Type: Trigger
* Description: Trigger on Classes__c 
* Date:        Developer/Company                 	Description
* ---------------------------------------------------------------------------------------------------------------------------------------- *
* 8/23/2018   Sharad Maheshwari/Deloitte           Initial Creation
**/
trigger ClassTrigger on Classes__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    TriggerDispatcher.Run(new ClassTriggerHandler());   
}