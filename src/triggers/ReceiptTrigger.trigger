...
* Name: ReceiptTrigger
* Type: Trigger
* Description: Trigger on MUSW__Receipt__c which calls ReceiptTriggerHandler if trigger have not been disabled
* Date:        Developer/Company                    Description
* ---------------------------------------------------------------------------------------------------------------------------------------- *
* 08/22/2018   Srikanth Kottam/Deloitte           Initial Creation
**/
trigger ReceiptTrigger on MUSW__Receipt__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    TriggerDispatcher.Run(new ReceiptTriggerHandler()); 
}