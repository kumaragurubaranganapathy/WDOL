...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Set_Estimated_Time</fullName>
        <field>Estimated_Completion_Time_Hours__c</field>
        <formula>1</formula>
        <name>Set Estimated Time</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Update_Completion_Time</fullName>
        <field>MUSW__Completed_DateTime__c</field>
        <formula>NOW()</formula>
        <name>Update Completion Time</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Update_the_Owner_to_Courses_Queue</fullName>
        <field>OwnerId</field>
        <lookupValue>Real_Estate_Appraiser_Courses_Queue</lookupValue>
        <lookupValueType>Queue</lookupValueType>
        <name>Update the Owner to Courses Queue</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <rules>
        <fullName>Queue Assignment for Appraiser Course</fullName>
        <actions>
            <name>Update_the_Owner_to_Courses_Queue</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
    ...
    <rules>
        <fullName>Set Estimated Completion Time for Review</fullName>
        <actions>
            <name>Set_Estimated_Time</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <formula>ISPICKVAL(MUSW__Permit2__r.Application_Type__c, &apos;Plan Review&apos;)</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
        <fullName>Set Review Completion Date</fullName>
        <actions>
            <name>Update_Completion_Time</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
