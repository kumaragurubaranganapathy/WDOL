...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <actions>
            <name>Email_to_RBS_Queue_for_request</name>
            <type>Task</type>
        </actions>
        <active>true</active>
...
ISPICKVAL(License__r.Application_Type__c, &apos;Landscape Architects&apos;) )</formula>
    ...
    <rules>
        ...
        <actions>
            <name>Email_to_RE_Queue_for_request</name>
            <type>Task</type>
        </actions>
        <active>true</active>
...
ISPICKVAL(License__r.Application_Type__c, &apos;Appraisal Management Companies&apos;))</formula>
    ...
    <rules>
        ...
        <actions>
            <name>Request_Applicant_Email_Update</name>
            <type>Task</type>
        </actions>
        <active>true</active>
    ...
    <tasks>
        <fullName>Email_to_RBS_Queue_for_request</fullName>
        <assignedToType>owner</assignedToType>
        <dueDateOffset>0</dueDateOffset>
        <notifyAssignee>false</notifyAssignee>
        <offsetFromField>Request__c.Current_Datetime__c</offsetFromField>
        ...
        <protected>false</protected>
        <status>Completed</status>
        <subject>Email to RBS Queue for request</subject>
    </tasks>
    <tasks>
        <fullName>Email_to_RE_Queue_for_request</fullName>
        <assignedToType>owner</assignedToType>
        <dueDateOffset>0</dueDateOffset>
        <notifyAssignee>false</notifyAssignee>
        <offsetFromField>Request__c.Current_Datetime__c</offsetFromField>
        ...
        <protected>false</protected>
        <status>Completed</status>
        <subject>Email to RE Queue for request</subject>
    </tasks>
    <tasks>
        <fullName>Request_Applicant_Email_Update</fullName>
        <assignedToType>owner</assignedToType>
        <dueDateOffset>0</dueDateOffset>
        <notifyAssignee>false</notifyAssignee>
        <offsetFromField>Request__c.Current_Datetime__c</offsetFromField>
        ...
        <protected>false</protected>
        <status>Completed</status>
        <subject>Request Applicant Email Update</subject>
    </tasks>
</Workflow>
