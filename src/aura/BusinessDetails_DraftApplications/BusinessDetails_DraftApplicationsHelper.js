            ...
            if (state === "SUCCESS") {
               ...
               var draftCourseAppList = [];
                ...
                for(var i = 0 ;i<appList.length;i++){
                    ...
                    if(appList[i].MUSW__Status__c == 'Pending' && appList[i].isRenewal__c == false && appList[i].Credential_Type__c != 'Apprasier Course'){
                    ...
                    }else if(appList[i].MUSW__Status__c == 'Pending' && appList[i].isRenewal__c == false && appList[i].Credential_Type__c =='Apprasier Course') {
                         console.log('courseList::'+ appList[i]);
                        draftCourseAppList.push(appList[i]);
                        component.set("v.courseListNotEmpty",true);
                    }else if(appList[i].MUSW__Status__c == 'Pending' && appList[i].isRenewal__c == true){
